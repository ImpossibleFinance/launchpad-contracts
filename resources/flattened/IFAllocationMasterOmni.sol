...
// File @omni/contracts/contracts/interfaces/IOmni.sol@v0.0.1
...
// File @omni/contracts/contracts/OmniCodec.sol@v0.0.1
...
// File @omni/contracts/contracts/OmniScient.sol@v0.0.1
...
// File contracts/IFAllocationMasterOmni.sol
...
// IFAllocationOmni extends all of functionalities from IFAllocationMaster.
// IFAllocationOmni is deployed on Omni chain. Receiving tx from IFAllocationMasterSource deployed on rollups.
contract IFAllocationMasterOmni is
    Ownable,
    ReentrancyGuard,
    ...
    OmniScient
{
    ...
    // OMNI INTEGRATION
    function addWhitelistedContract(address _address) public onlyOwner {
        whitelistedContracts[_address] = true;
    }

    function removeWhitelistedContract(address _address) public onlyOwner {
