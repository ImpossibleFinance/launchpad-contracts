...
export default describe('vIDIA', async () => {
  ...
  it('test cancelpendingunstake', async () => {
    ...
    expect((await tx.wait()).gasUsed).to.eq(123694) // 139231
  })
